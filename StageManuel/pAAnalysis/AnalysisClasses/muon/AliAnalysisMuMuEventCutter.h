...
public:
  ...
  Bool_t IsNtrCorrInRange(AliVEvent& event, const Double_t& ntrcorrMin, const Double_t& ntrcorrMax) const;
  void NameOfIsNtrCorrInRange(TString& name, const Double_t& dNchdEtaMin, const Double_t& dNchdEtaMax) const;
