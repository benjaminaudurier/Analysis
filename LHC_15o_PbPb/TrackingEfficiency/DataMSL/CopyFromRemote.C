...
void CopyFromRemote(const char* txtfile="grid.esd.txt")
{
  ...
  while ( in.getline(line,1024,'\n') )
  {
    ...
    gSystem->mkdir(Form("/Users/audurier/Documents/Analysis/LHC_15o_PbPb/TrackingEfficiency/DataMSL/%s",dir.Data()),kTRUE);
    ...
    {
      if(TFile::Cp(line,Form("/Users/audurier/Documents/Analysis/LHC_15o_PbPb/TrackingEfficiency/DataMSL/%s",file.Data())))
      {
      ...
      else gSystem->Exec(Form("rm -rf /Users/audurier/Documents/Analysis/LHC_15o_PbPb/TrackingEfficiency/DataMSL/%s",dir.Data()));
