...
TString alirootVersion = "v5-08-00-3";
TString aliphysicsVersion = "vAN-20160224-1";
TString dataDir = "/alice/cern.ch/user/b/baudurie/Analysis/LHC15o/sim/singleMuontuned/CMSL7-B-NOPF-MUFAST/";
TString dataPattern = "*/AliESDs.root";
TString runFormat = "%06d";
TString outDir = "Analysis/LHC15o/TrackingEfficiency/MonteCarlo/singleMuon/tuned/WiththnSparse";
// TString outDir = "Analysis/LHC15o/TrackingEfficiency/MonteCarlo/singleMuon/tuned/WiththnSparse/smallrunlist";
Int_t ttl = 30000;
