#ifndef ALIANALYSISTASKGENTUNERLOCAL_H
#define ALIANALYSISTASKGENTUNERLOCAL_H
/* Copyright(c) 1998-1999, ALICE Experiment at CERN, All rights reserved. *
 * See cxx source for full Copyright notice                               */

/// \ingroup muondep
/// \class AliAnalysisTaskGenTunerLocal
...
class AliAnalysisTaskGenTunerLocal : public AliAnalysisTaskSE {
public:
  
  AliAnalysisTaskGenTunerLocal();
  AliAnalysisTaskGenTunerLocal(const char *name);
  virtual ~AliAnalysisTaskGenTunerLocal();
  ...
  TString GetDataFile() {return fDataFile ;}
...
private:
  ...
  /// Not implemented
  AliAnalysisTaskGenTunerLocal(const AliAnalysisTaskGenTunerLocal& rhs);
  /// Not implemented
  AliAnalysisTaskGenTunerLocal& operator = (const AliAnalysisTaskGenTunerLocal& rhs);
...
private:
  ...
  ClassDef(AliAnalysisTaskGenTunerLocal, 1);
};

//________________________________________________________________________
inline void AliAnalysisTaskGenTunerLocal::SetMuonTrackCuts(AliMuonTrackCuts &trackCuts)
{
  /// set standard cuts to select tracks to be considered
