...
#include "AliAnalysisTaskGenTunerLocal.h"


ClassImp(AliAnalysisTaskGenTunerLocal)

//________________________________________________________________________
AliAnalysisTaskGenTunerLocal::AliAnalysisTaskGenTunerLocal() :
AliAnalysisTaskSE(),
fList(0x0),
fCentMin(-FLT_MAX),
fCentMax(FLT_MAX),
...
//________________________________________________________________________
AliAnalysisTaskGenTunerLocal::AliAnalysisTaskGenTunerLocal(const char *name) :
...
void AliAnalysisTaskGenTunerLocal::UserCreateOutputObjects()
{
  /// Create histograms
...
//________________________________________________________________________
void AliAnalysisTaskGenTunerLocal::NotifyRun()
{
...
//________________________________________________________________________
void AliAnalysisTaskGenTunerLocal::UserExec(Option_t *)
{
  /// process event
...
//________________________________________________________________________
void AliAnalysisTaskGenTunerLocal::Terminate(Option_t *)
{
  /// post-processing
...
//________________________________________________________________________
void AliAnalysisTaskGenTunerLocal::SetPtParam(const Double_t *pOld, const Bool_t *fixOld, const Double_t *pNew,
...
//________________________________________________________________________
void AliAnalysisTaskGenTunerLocal::SetYParam(const Double_t *pOld, const Bool_t *fixOld, const Double_t *pNew,
					const Bool_t *fixNew, Double_t min, Double_t max)
{
...
//________________________________________________________________________
TH1* AliAnalysisTaskGenTunerLocal::ComputeAccEff(TH1 &hGen, TH1 &hRec, const Char_t *name, const Char_t *title)
{
...
//________________________________________________________________________
Double_t AliAnalysisTaskGenTunerLocal::Pt(const Double_t *x, const Double_t *p)
{
...
//________________________________________________________________________
Double_t AliAnalysisTaskGenTunerLocal::Y(const Double_t *x, const Double_t *p)
{
...
Double_t AliAnalysisTaskGenTunerLocal::PtRat(const Double_t *x, const Double_t *p)
{
...
//________________________________________________________________________
Double_t AliAnalysisTaskGenTunerLocal::YRat(const Double_t *x, const Double_t *p)
{
...
//________________________________________________________________________
Double_t AliAnalysisTaskGenTunerLocal::GetFitLowEdge(TH1 &h)
{
...
//________________________________________________________________________
Double_t AliAnalysisTaskGenTunerLocal::GetFitUpEdge(TH1 &h)
{
...
//________________________________________________________________________
void AliAnalysisTaskGenTunerLocal::NormFunc(TF1 *f, Double_t min, Double_t max)
{
