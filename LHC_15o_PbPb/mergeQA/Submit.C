...
void Submit(const char* inDir ="/alice/cern.ch/user/b/baudurie/Analysis/LHC15o/sim/singleMuontuned/CMSL7-B-NOPF-MUFAST", const char* outDir="Analysis/LHC15o/sim/singleMuontuned/CMSL7-B-NOPF-MUFAST/QA", const char* resDir = "results",
	    const char* runList = "run-list.txt", TString runFormat = "%06d", Int_t stage = 0, Bool_t submit = kTRUE)
{
