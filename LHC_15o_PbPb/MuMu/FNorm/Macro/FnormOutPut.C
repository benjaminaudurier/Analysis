	...
	const char * filename3 ="../TrainRootFile/ResultsRawEvents.root")
{
	...
	// Ratio
	TH1*FnormOffline1Offline2PUPS =0x0;
	TH1*FnormOffline1ScalerPUPS =0x0;
	TH1*FnormOffline2ScalerPUPS =0x0;
	...
	FnormOffline1Offline2PUPS = static_cast<TH1*>(ana.OC()->GetObject("/FNORM/Offline/GRAPHS/FnormOffline1PUPS_AsHisto")->Clone());
	FnormOffline1ScalerPUPS   = static_cast<TH1*>(ana.OC()->GetObject("/FNORM/Offline/GRAPHS/FnormOffline1PUPS_AsHisto")->Clone());
	FnormOffline2PUPS         = static_cast<TH1*>(ana.OC()->GetObject("/FNORM/Offline/GRAPHS/FnormOffline2PUPS_AsHisto")->Clone());
	FnormOffline2ScalerPUPS   = static_cast<TH1*>(ana.OC()->GetObject("/FNORM/Offline/GRAPHS/FnormOffline2PUPS_AsHisto")->Clone());
	...
	c3->cd(2);
	FnormOffline1Offline2PUPS->SetTitle("Ratio");
	FnormOffline1Offline2PUPS->SetName("Offlin1OverOffline2");
	FnormOffline1ScalerPUPS->SetTitle("Ratio");
	FnormOffline1ScalerPUPS->SetName("Offlin1OverScaler");
	FnormOffline2ScalerPUPS->SetTitle("Ratio");
	FnormOffline2ScalerPUPS->SetName("Offlin2OverScaler");
	...
	leg4->AddEntry(FnormOffline1Offline2PUPS,"FNormOffline1/Scaler","pe");
	leg4->AddEntry(FnormOffline2ScalerPUPS,"FNormOffline2/Scaler","pe");
	FnormOffline1Offline2PUPS->Divide(FnormOffline2PUPS);
	FnormOffline1Offline2PUPS->GetYaxis()->SetRangeUser(0,1.5);
	FnormOffline1Offline2PUPS->SetMarkerColor(2);
	FnormOffline1Offline2PUPS->SetMarkerSize(0.55);
	FnormOffline1Offline2PUPS->SetMarkerStyle(8);
	FnormOffline1Offline2PUPS->DrawCopy();
	FnormOffline1ScalerPUPS->Divide(FnormScalersPUPS);
	FnormOffline1ScalerPUPS->SetMarkerColor(3);
	FnormOffline1ScalerPUPS->SetMarkerSize(0.55);
	FnormOffline1ScalerPUPS->SetMarkerStyle(8);
	FnormOffline1ScalerPUPS->DrawCopy("same");
	FnormOffline2ScalerPUPS->Divide(FnormScalersPUPS);
	FnormOffline2ScalerPUPS->SetMarkerColor(4);
	FnormOffline2ScalerPUPS->SetMarkerSize(0.55);
	FnormOffline2ScalerPUPS->SetMarkerStyle(8);
	FnormOffline2ScalerPUPS->DrawCopy("same");
	leg4->Draw("same");

	// Store the results
	TFile* fnormFile = new TFile("FnormResults.root","RECREATE");
	FnormOffline1PUPS->Write();
	FnormOffline2PUPS->Write();
	FnormScalersPUPS->Write();
	FnormOffline1Offline2PUPS->Write();
	FnormOffline1ScalerPUPS->Write();
	FnormOffline2ScalerPUPS->Write();
	fnormFile->Close();
