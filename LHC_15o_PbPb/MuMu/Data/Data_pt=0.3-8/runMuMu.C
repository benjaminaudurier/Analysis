...
AliAnalysisTask* runMuMu(TString runMode, 
                        ...
                        TString inputName       = "Find;BasePath=/alice/data/2015/LHC15o/000244918/muon_calo_pass1/AOD175/;FileName=AliAOD.Muons.root;",
                        ...
                        TString taskOptions     = "" )
{
    ...
    SetupAnalysis(runMode,analysisMode,inputName,inputOptions,softVersions,analysisOptions, "PWGmuon.par /Users/audurier/Documents/Analysis/LHC_15o_PbPb/MuMuPar/Data_0-12/AddTaskMuMu.C",". $ALICE_ROOT/include $ALICE_PHYSICS/include");
