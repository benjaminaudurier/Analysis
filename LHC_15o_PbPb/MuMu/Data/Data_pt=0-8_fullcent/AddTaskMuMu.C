...
//    C0T0A,C0T0C,MB1,MBBG1,V0L,V0R,MULow,EMPTY,MBBG3,MULL,MULU,MUHigh
  ...
  if (!simulations)
  {
    ps = cr->AddEventCut(*eventCutter,"IsPhysicsSeelectedMUL","const AliInputEventHandler&","");
  ...
  binning->AddBin("centrality","V0M",,1);
  binning->AddBin("centrality","V0M",1,2);
  binning->AddBin("centrality","V0M",2,3);
  binning->AddBin("centrality","V0M",3,4);
  binning->AddBin("centrality","V0M",4,5);
  binning->AddBin("centrality","V0M",5,6);
  binning->AddBin("centrality","V0M",6,7);
  binning->AddBin("centrality","V0M",7,8);
  binning->AddBin("centrality","V0M",8,9);
