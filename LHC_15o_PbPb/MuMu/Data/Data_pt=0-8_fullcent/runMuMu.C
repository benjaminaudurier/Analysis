                        ...
                        TString taskOptions     = "" )
{
    ...
    SetupAnalysis(runMode,analysisMode,inputName,inputOptions,softVersions,analysisOptions, "PWGmuon.par /Users/audurier/Documents/Analysis/LHC_15o_PbPb/MuMuPar/Data_0-8/AddTaskMuMu.C",". $ALICE_ROOT/include $ALICE_PHYSICS/include");
