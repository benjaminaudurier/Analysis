                             ...
                             Bool_t simulations)
{
  ...
  if (minvAnalysis)
  {
    ...
    // very low pt binning
    binning->AddBin("psi","pt", 0.0, 0.1,"LOWPT");
    binning->AddBin("psi","pt", 0.1, 0.2,"LOWPT");
    binning->AddBin("psi","pt", 0.2, 0.3,"LOWPT");
    binning->AddBin("psi","pt", 0.3, 0.4,"LOWPT");
    binning->AddBin("psi","pt", 0.4, 0.5,"LOWPT");
    binning->AddBin("psi","pt", 0.5, 0.6,"LOWPT");
    binning->AddBin("psi","pt", 0.6, 0.7,"LOWPT");
    binning->AddBin("psi","pt", 0.7, 0.8,"LOWPT");
    binning->AddBin("psi","pt", 0.8, 0.9,"LOWPT");
    binning->AddBin("psi","pt", 0.9, 1.0,"LOWPT");
    binning->AddBin("psi","pt", 1.0, 1.1,"LOWPT");
    binning->AddBin("psi","pt", 1.1, 1.2,"LOWPT");
    binning->AddBin("psi","pt", 1.2, 1.3,"LOWPT");
    binning->AddBin("psi","pt", 1.3, 1.4,"LOWPT");
    binning->AddBin("psi","pt", 1.4, 1.5,"LOWPT");
    binning->AddBin("psi","pt", 1.5, 1.6,"LOWPT");
    binning->AddBin("psi","pt", 1.6, 1.7,"LOWPT");
    binning->AddBin("psi","pt", 1.7, 1.8,"LOWPT");

    binning->AddBin("psi","pt", 0.0, 0.3,"LOWPTINT1");
    binning->AddBin("psi","pt", 0.3, 1.0,"LOWPTINT2");
    binning->AddBin("psi","pt", 1.0, 8.0,"LOWPTINT3");
