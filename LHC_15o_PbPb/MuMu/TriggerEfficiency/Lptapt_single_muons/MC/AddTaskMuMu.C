                             ...
                             Bool_t simulations)
{
  ...
  AliAnalysisMuMuTriggerResponse* triggResponse    = new AliAnalysisMuMuTriggerResponse;// Analysis dealing with single muon
  ...
  if ( singleAnalysis ){
    ...
    cr->AddCutCombination(trackTrue,rabs,matchany,eta,pdca);
    ...
    if (triggResponse) task->AdoptSubAnalysis(triggResponse);
