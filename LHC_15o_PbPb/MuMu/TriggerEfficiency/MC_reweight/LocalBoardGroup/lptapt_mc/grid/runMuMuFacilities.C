...
///
  ...
  TString aliphysicsVersion = "vAN-20161218-1";
  TString extraLibs         ="";
  ...
  // --- grid specific setup ---
  TString dataDir           = "/alice/sim/2016/LHC16e2";
  TString dataPattern       = "p20/AOD/*/AliAOD.Muons.root";
  TString runFormat         = "%d";
  TString outDir            = "Analysis/LHC15o/TriggerSyst/MC_reweight/lptapt_mc/LHC16e2";
  TString analysisMacroName = "TrigSyst";
  Int_t ttl                 = 30000;
...
void runMuMuFacilities(TString smode = "local", TString inputFileName = "AliAOD.Muons.root", Bool_t isMC = kFALSE)
{
  ...
  fileList.Add(new TObjString( "ReferenceResults_MC.root" ));
