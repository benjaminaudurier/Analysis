...
///
  ...
  // --- grid specific setup ---
  TString dataDir           = "/alice/cern.ch/user/m/mtarhini/testGeant4/outputGeant4Full6/";
  TString dataPattern       = "*/AliAOD.Muons.root";
  TString runFormat         = "%d";
  TString outDir            = "Analysis/LHC15o/MuMu_sim_Mohamad";
  TString analysisMacroName = "MCMuMu";
  Int_t ttl                 = 10300;
