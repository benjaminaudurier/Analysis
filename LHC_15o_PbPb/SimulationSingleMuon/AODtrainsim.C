...
void AddAnalysisTasks(Int_t merge){
  ...
  if (iESDfilter) {
    ...
    AliAnalysisTaskESDfilter *taskesdfilter = AddTaskESDFilter(useKFILTER, iMUONcopyAOD, kFALSE, kFALSE /*usePhysicsSelection*/,kFALSE,kTRUE,kTRUE,kTRUE,1100,1); // others
    ...
    if ( 0 && 0 ) /* 0 for the moment to get this macro running also with AliRoot <= .... */
    {
