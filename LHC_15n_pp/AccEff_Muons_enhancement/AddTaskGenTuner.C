AliAnalysisTaskGenTunerEnhanced* AddTaskGenTuner()
{
  /// Add AliAnalysisTaskGenTunerEnhanced to the train (Philippe Pillot)
  ...
  AliAnalysisTaskGenTunerEnhanced *task = new AliAnalysisTaskGenTunerEnhanced("GenTuner");
  if (!task) {
