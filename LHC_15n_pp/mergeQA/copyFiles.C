...
void copyFiles(TString gridLocation = "Analysis/LHC15n/sim/singleMuon/CMSL7-B-NOPF-MUFAST/QA/")
{
  ...
  TString localDir = "/Users/audurier/Documents/Analysis/LHC_15n_pp/mergeQA";
  TString targetDir = "/alice/cern.ch/user/b/baudurie/";
  ...
  gSystem->Exec(Form("alien_cp file:%s/AOD_merge.jdl alien://%s/AOD_merge.jdl", localDir.Data(), targetDir.Data()));
  gSystem->Exec(Form("alien_cp file:%s/AOD_merge_final.jdl alien://%s/AOD_merge_final.jdl", localDir.Data(), targetDir.Data()));
  gSystem->Exec(Form("alien_cp file:%s/validation_merge.sh alien://%s/validation_merge.sh", localDir.Data(), targetDir.Data()));
