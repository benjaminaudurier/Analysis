...
void Submit(const char* inDir ="/alice/cern.ch/user/b/baudurie/Analysis/LHC15n/sim/singleMuon/CMSL7-B-NOPF-MUFAST", const char* outDir="Analysis/LHC15n/sim/singleMuon/CMSL7-B-NOPF-MUFAST/QA", const char* resDir = "results",
