...
void PrintCounters(AliAnalysisMuMu &ana)
{
    ...
    ana.CC()->Print("-");
    ana.CC()->Print("run/trigger/centrality/event","trigger:CINT7-B-NOPF-MUFAST/centrality:V0A");
    ana.CC()->Print("run/trigger/centrality/event","trigger:CMUL7-B-NOPF-MUFAST/centrality:V0A");
