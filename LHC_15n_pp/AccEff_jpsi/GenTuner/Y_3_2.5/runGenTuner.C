...
Bool_t newFixYParam[2] = {kTRUE, kTRUE};
...
//For Y projection
Int_t firstybin=lastybin=3; // Projection bin in rapidity. No projection if =-1
// For pT Projection
     ...
     Int_t iStep = 0, char overwrite = '\0')
{
  ...
  fileList.Add(new TObjString("/Users/audurier/Documents/Analysis/Tasks/AliAnalysisTaskGenTunerJpsi.cxx"));
  fileList.Add(new TObjString("/Users/audurier/Documents/Analysis/Tasks/AliAnalysisTaskGenTunerJpsi.h"));
