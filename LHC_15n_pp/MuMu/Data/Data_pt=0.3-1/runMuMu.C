                        ...
                        TString taskOptions     = "" )
{
    ...
    SetupAnalysis(runMode,analysisMode,inputName,inputOptions,softVersions,analysisOptions,"PWGmuon.par /Users/audurier/Documents/Analysis/LHC_15n_pp/MuMu/Data/Data_pt=0.3-1/AddTaskMuMu.C",". $ALICE_ROOT/include $ALICE_PHYSICS/include");
    ...
    if (!isMC) triggers->Add(new TObjString("CMUL7-B-NOPF-MUFAST")); // pp trigger
