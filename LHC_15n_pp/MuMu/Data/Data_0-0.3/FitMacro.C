...
char           * sasso="../../Simulation/pt=0.0-0.3/AnalysisResults.JPSI.root";
char           * sasso2="";
...
void FitMacro( char* what ="pt",const char* printWhat = "", int debug =0 )
{
   ...
   //General conf.
    ...
    // if(rawcount){
    //     analysis.ComputeDimuonRawCount(2.8,3.4,what,"","BENJ");
    //     analysis.ComputeDimuonRawCount(2.1,2.8,what,"","BENJ");
    // }
