...
//    C0T0A,C0T0C,MB1,MBBG1,V0L,V0R,MULow,EMPTY,MBBG3,MULL,MULU,MUHigh
  ...
  if ( singleAnalysis )
  {
    ...
    if ( minvAnalysis )
    {
      ...
      AliAnalysisMuMuCutElement* ptRange = cr->AddTrackPairCut(*minvAnalysis,"IsPtInRange","const AliVParticle&,const AliVParticle&,Double_t&,Double_t&","0.,15.");
  ...
  if (minvAnalysis)
  {
    ...
    binning->AddBin("psi","pt", 12.0, 15.0,"BENJ");
