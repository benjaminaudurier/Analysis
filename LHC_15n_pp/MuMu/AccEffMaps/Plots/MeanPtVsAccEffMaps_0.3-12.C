...
//=========  (Sat Nov  5 21:02:26 2016) by ROOT version5.34/30
   TCanvas *c1 = new TCanvas("c1", "c1",32,45,700,500);
   c1->Range(-2,2.370787,18,2.459977);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   TH1F *meanpttests__1 = new TH1F("meanpttests__1","Meant pt vs AccEff maps (PT_INT_PUTCUT_00.30_12.00)",16,0,16);
   meanpttests__1->SetBinContent(1,2.408614);
   meanpttests__1->SetBinContent(2,2.426497);
   meanpttests__1->SetBinContent(3,2.411486);
   meanpttests__1->SetBinContent(4,2.408959);
   meanpttests__1->SetBinContent(5,2.416982);
   meanpttests__1->SetBinContent(6,2.417737);
   meanpttests__1->SetBinContent(7,2.417836);
   meanpttests__1->SetBinContent(8,2.413289);
   meanpttests__1->SetBinContent(9,2.403259);
   meanpttests__1->SetBinContent(10,2.415968);
   meanpttests__1->SetBinContent(11,2.41629);
   meanpttests__1->SetBinContent(12,2.427184);
   meanpttests__1->SetBinContent(13,2.406822);
   meanpttests__1->SetBinContent(14,2.414391);
   meanpttests__1->SetBinContent(15,2.415776);
   meanpttests__1->SetBinContent(16,2.403951);
   meanpttests__1->SetBinError(1,0.020352);
   meanpttests__1->SetBinError(2,0.0203701);
   meanpttests__1->SetBinError(3,0.02026422);
   meanpttests__1->SetBinError(4,0.02041093);
   meanpttests__1->SetBinError(5,0.02031004);
   meanpttests__1->SetBinError(6,0.02026608);
   meanpttests__1->SetBinError(7,0.02067069);
   meanpttests__1->SetBinError(8,0.02026542);
   meanpttests__1->SetBinError(9,0.0203169);
   meanpttests__1->SetBinError(10,0.02028852);
   meanpttests__1->SetBinError(11,0.0203345);
   meanpttests__1->SetBinError(12,0.02047613);
   meanpttests__1->SetBinError(13,0.0204027);
   meanpttests__1->SetBinError(14,0.02040781);
   meanpttests__1->SetBinError(15,0.02037086);
   meanpttests__1->SetBinError(16,0.02012524);
   ...
   text = ptstats->AddText("Mean  =  7.998");
   ...
   meanpttests__1->Draw("");
   TLine *line = new TLine(0,2.414065,16,2.414065);

   ci = TColor::GetColor("#0000ff");
   line->SetLineColor(ci);
   line->SetLineWidth(3);
   line->Draw();
   line = new TLine(0,2.407408,16,2.407408);
   ...
   line->SetLineWidth(3);
   line->Draw();
   line = new TLine(0,2.420722,16,2.420722);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   text = pt->AddText("Meant pt vs AccEff maps (PT_INT_PUTCUT_00.30_12.00)");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
