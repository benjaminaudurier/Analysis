    ...
    if (simulations)
{
  ...
  minvAnalysis->SetNewYFunc(newYFormula.Data(), newYParam, yRangeFunc[0], yRangeFunc[1]);
    ...
    // y binning
    binning->AddBin("psi","ptvsy",-4,-3.75,0.,3.0,"range1");
    binning->AddBin("psi","ptvsy",-3.75,-3.5,0.,3.0,"range1");
    binning->AddBin("psi","ptvsy",-3.5,-3.25,0.,3.0,"range1");
    binning->AddBin("psi","ptvsy",-3.25,-3,0.,3.0,"range1");
    binning->AddBin("psi","ptvsy",-3,-2.75,0.,3.0,"range1");
    binning->AddBin("psi","ptvsy",-2.75,-2.5,0.,3.0,"range1");

    binning->AddBin("psi","ptvsy",-4,-3.75,3.0,6.0,"range2");
    binning->AddBin("psi","ptvsy",-3.75,-3.5,3.0,6.0,"range2");
    binning->AddBin("psi","ptvsy",-3.5,-3.25,3.0,6.0,"range2");
    binning->AddBin("psi","ptvsy",-3.25,-3,3.0,6.0,"range2");
    binning->AddBin("psi","ptvsy",-3,-2.75,3.0,6.0,"range2");
    binning->AddBin("psi","ptvsy",-2.75,-2.5,3.0,6.0,"range2");

    binning->AddBin("psi","ptvsy",-4,-3.75,6.0,12.0,"range3");
    binning->AddBin("psi","ptvsy",-3.75,-3.5,6.0,12.0,"range3");
    binning->AddBin("psi","ptvsy",-3.5,-3.25,6.0,12.0,"range3");
    binning->AddBin("psi","ptvsy",-3.25,-3,6.0,12.0,"range3");
    binning->AddBin("psi","ptvsy",-3,-2.75,6.0,12.0,"range3");
    binning->AddBin("psi","ptvsy",-2.75,-2.5,6.0,12.0,"range3");
