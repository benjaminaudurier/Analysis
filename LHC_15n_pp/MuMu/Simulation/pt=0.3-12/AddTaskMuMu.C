...
//    C0T0A,C0T0C,MB1,MBBG1,V0L,V0R,MULow,EMPTY,MBBG3,MULL,MULU,MUHigh
  ...
  if ( singleAnalysis ){
    ...
    if ( minvAnalysis ){
      ...
      AliAnalysisMuMuCutElement* ptRange = cr->AddTrackPairCut(*minvAnalysis,"IsPtInRange","const AliVParticle&,const AliVParticle&,Double_t&,Double_t&","0.3,12.0");
  ...
  if (minvAnalysis){
    ...
    binning->AddBin("psi","pt", 0.3, 12.0,"BENJ");
  } 
