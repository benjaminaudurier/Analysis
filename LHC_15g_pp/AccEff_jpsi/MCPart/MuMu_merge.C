void MuMu_merge(const char *dir, Int_t stage=0)
{
...
// Set temporary compilation directory to current one
   ...
   TString outputFiles = "AnalysisResultsReference.root";
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("MuMu.root");
   if (!mgr) {
