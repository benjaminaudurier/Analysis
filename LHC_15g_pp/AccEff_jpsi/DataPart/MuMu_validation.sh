...
if ! [ -f AnalysisResultsReference.root ] ; then
   error=1
   echo "Output file AnalysisResultsReference.root not found. Job FAILED !" >> stdout
   echo "Output file AnalysisResultsReference.root not found. Job FAILED !" >> stderr
fi
