...
do
echo -e "alien:///alice/cern.ch/user/b/baudurie/Analysis/LHC15g/TrackingEfficiency/simsinglemuon/pp/CMSL7-B-NOPF-MUON/QA/results/$line/Merged.QA.Data.root" >> grid.QA.txt
