...
do
echo -e "alien:///alice/cern.ch/user/b/baudurie/Analysis/LHC15g/TrackingEfficiency/MonteCarlo/singleMuon/new/results/$line/AnalysisResults.root" >> grid.esd.txt
