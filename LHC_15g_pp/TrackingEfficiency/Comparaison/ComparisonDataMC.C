...
{ 
  ...
  TCanvas *c = new TCanvas(name, "ratio",1200,800);
  ...
  if (minData < minSim && maxData < maxSim )
  {
    minA = minData ;
    maxA = maxSim ;
  }
...
//  
  // save output
  TFile* file = new TFile("EffComparisonTune1rejectPt1.root","update");
