...
void ComparisonPPPTBINWithAnalysisNote(){
...
Double_t cs[npt]       ={ 0.912,0.5509,0.0727,0.008075};
Double_t estat_cs[npt] ={ 0.0196,0.0119,0.0032,0.0008};
Double_t esyst_cs[npt] ={ 0.0308,0.0147,0.0018,0.0003};
Double_t etotglobal_cs[npt];
Double_t etotfull[npt];
...
Double_t cs_PTNEW[npt]       ={0.9161,0.5527,0.0732,0.0080};
Double_t estat_cs_PTNEW[npt] ={0.0202,0.0122,0.0034,0.0008};
Double_t esyst_cs_PTNEW[npt] ={0.0418,0.0248,0.0028,0.0003};
