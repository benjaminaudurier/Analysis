...
Int_t       iMUONPerformance   = 0;      // Task to study the muon performances in MC simulation (> 1 = use parfile)
Int_t       iMUONEfficiency    = 0;      // Task to measure the muon efficiency                  (> 1 = use parfile)
Int_t       iMUONPhysics       = 0;      // Task to make some physics analysis
