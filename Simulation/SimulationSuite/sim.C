...
//  simulator.SetSpecificStorage("MUON/Align/Data","alien://folder=/alice/cern.ch/user/j/jcastill/pbpb15wrk/LHC15o_mcp1vsreal_MisAlignCDB");
...
//  simulator.UseVertexFromCDB(); // also need to activate ITS in Config.C to have it in GRP for the reco
