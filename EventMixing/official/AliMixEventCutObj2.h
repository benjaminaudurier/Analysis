...
#ifndef ALIMIXEVENTCUTOBJ2_H
#define ALIMIXEVENTCUTOBJ2_H
...
class AliAODEvent;
class AliESDEvent;
class AliMixEventCutObj2 : public TObject {
public:
   ...
   AliMixEventCutObj2(AliMixEventCutObj2::EEPAxis_t type = kMultiplicity, Float_t min = 0.0, Float_t max = 0.0, Float_t step = 1.0, const char *opt = "");
   AliMixEventCutObj2(const AliMixEventCutObj2 &obj);
   AliMixEventCutObj2 &operator=(const AliMixEventCutObj2 &obj);
