...
ClassImp(AliMixInputEventHandler2)

//_____________________________________________________________________________
AliMixInputEventHandler2::AliMixInputEventHandler2(const Int_t size, const Int_t mixNum): AliMultiInputEventHandler(size),
   fMixTrees(),
...
//_____________________________________________________________________________
AliMixInputEventHandler2::~AliMixInputEventHandler2() {
   //
   // Destructor
   //
   fMixTrees.Clear();
...
//_____________________________________________________________________________
void AliMixInputEventHandler2::SetInputHandlerForMixing(const AliInputEventHandler *const inHandler)
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::Init(TTree *tree, Option_t *opt)
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::Notify()
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::Notify(const char *path)
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::BeginEvent(Long64_t entry)
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::GetEntry()
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::MixStd()
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::MixBuffer()
{
   //
   // Mix in event buffer
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::MixEventsMoreTimesWithOneEvent()
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::MixEventsMoreTimesWithBuffer()
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::FinishEvent()
{
   //
...
//_____________________________________________________________________________
void AliMixInputEventHandler2::AddInputEventHandler(AliVEventHandler *)
{
   //
...
//_____________________________________________________________________________
void AliMixInputEventHandler2::UserExecMixAllTasks(Long64_t entryCounter, Int_t idEntryList, Long64_t entryMainReal, Long64_t entryMixReal, Int_t numMixed)
{
   //
...
//_____________________________________________________________________________
void AliMixInputEventHandler2::SetMixNumber(const Int_t mixNum)
{
   //
   // Sets mix number
   //
   if (fMixNumber > 1 && fBufferSize > 1) {
      ...
      AliWarning(Form("\t\tAliMixInputEventHandler2 *mixH = new AliMixInputEventHandler2(%d,1)", fBufferSize));
      AliWarning("");
      AliWarning("\t2.If you want to use mix more time with buffer size 1, then do:");
      AliWarning(Form("\t\tAliMixInputEventHandler2 *mixH = new AliMixInputEventHandler2(1,%d)", mixNum));
      AliWarning("");
      AliWarning("=========================================================================================");
      gSystem->Sleep(10000);
      fBufferSize = 1;
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::IsEventCurrentSelected()
{
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::GetEntryMainEvent() {
   //
...
//_____________________________________________________________________________
Bool_t AliMixInputEventHandler2::GetEntryMixedEvent(Int_t id) {
   //
