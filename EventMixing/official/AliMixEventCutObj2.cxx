...
ClassImp(AliMixEventCutObj2)

//_________________________________________________________________________________________________
AliMixEventCutObj2::AliMixEventCutObj2(AliMixEventCutObj2::EEPAxis_t type, Float_t min, Float_t max, Float_t step, const char *opt) : TObject(),
   fCutType((Int_t)type),
   fCutOpt(opt),
   fCutMin(min),
   fCutMax(max),
...
//_________________________________________________________________________________________________
AliMixEventCutObj2::AliMixEventCutObj2(const AliMixEventCutObj2 &obj) : TObject(obj),
...
//_________________________________________________________________________________________________
AliMixEventCutObj2 &AliMixEventCutObj2::operator=(const AliMixEventCutObj2 &obj)
{
   //
   // Assigned operator
   //
...
//_________________________________________________________________________________________________
Bool_t AliMixEventCutObj2::HasMore() const
{
   //
...
//_________________________________________________________________________________________________
void AliMixEventCutObj2::AddStep()
{
   //
   // Adds step
   //
...
//_________________________________________________________________________________________________
void AliMixEventCutObj2::Print(const Option_t *) const
{
   //
...
//_________________________________________________________________________________________________
void AliMixEventCutObj2::PrintCurrentInterval()
{
   //
...
//_________________________________________________________________________________________________
Int_t AliMixEventCutObj2::GetNumberOfBins() const
{
   //
...
//_________________________________________________________________________________________________
Int_t AliMixEventCutObj2::GetBinNumber(Float_t num) const
{
   //
...
//_________________________________________________________________________________________________
Int_t AliMixEventCutObj2::GetIndex(AliVEvent *ev)
{
   //
...
//_________________________________________________________________________________________________
Double_t AliMixEventCutObj2::GetValue(AliVEvent *ev)
{
   //
...
//_________________________________________________________________________________________________
Double_t AliMixEventCutObj2::GetValue(AliESDEvent *ev)
{
   //
...
//_________________________________________________________________________________________________
Double_t AliMixEventCutObj2::GetValue(AliAODEvent *ev)
{
   //
...
//_________________________________________________________________________________________________
const char *AliMixEventCutObj2::GetCutName(Int_t index) const
{
   //
   // Retruns name of cut
   //
...
//_________________________________________________________________________________________________
void AliMixEventCutObj2::SetCurrentValueToIndex(Int_t index)
{
   //
...
//_________________________________________________________________________________________________
void AliMixEventCutObj2::PrintValues(AliVEvent *main, AliVEvent *mix)
{
   //
...
//_________________________________________________________________________________________________
Bool_t AliMixEventCutObj2::IsValid()
{
   //
