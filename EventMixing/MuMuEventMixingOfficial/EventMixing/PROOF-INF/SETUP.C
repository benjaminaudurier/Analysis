// Automatically generated SETUP.C for EventMixing
...
Int_t SETUP() {
  ...
  // (this is a ROOT bug)
  // buf.Form("%s/libEventMixing.rootmap", wd);
  // gInterpreter->UnloadLibraryMap("libEventMixing");
